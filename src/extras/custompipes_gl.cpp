...
CreateRimLightPipes(void)
{
	...
	// Adreno 220 doesn't support dynamic array indexing in GLSL ES 1.00
	// Skip rim skin shader creation
	{
...
#include "shaders/obj/neoRim_vert.inc"
...
#ifndef WEBOS_TOUCHPAD
	// Skip rim skin pipeline creation for webOS
	...
	rimSkinPipe = pipe;
#else
	// Use non-skinned rim pipeline for skinned objects on webOS
	rimSkinPipe = rimPipe;
#endif
}
